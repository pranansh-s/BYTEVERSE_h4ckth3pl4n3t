...
const DayRow = ({day}) => {
  ...
  return (
    <div className="flex items-center m-[1.1vh] relative">
      <h2 className="w-20 font-bold text-center pr-3 font-montserrat">{day}</h2>
      ...
      <div className="flex w-full -top-[0.75rem] absolute items-center">
        <div className="absolute -ml-4">
          <div className="h-5 w-5 border-l border-t border-r border-b-transparent border-4 border-black absolute top-2 -rotate-45 rounded-full"/>
          <div className="h-5 w-5 border-l border-t border-r border-b-transparent border-4 border-black -rotate-45 rounded-full"/>
        </div>
